...
check-build: ## Assert feeds, removed outputs, profile data, navigation, KaTeX, heading links, and time dates
...
test: ## Run Python unit tests for navigation, positioning, CV tools, KaTeX, and built HTML semantics
